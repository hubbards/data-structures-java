 ...
 *
 * @param <E>
 * the element type of this heap
 */
public class Heap<E extends Comparable<E>> {
    private static final int DEFAULT_CAPACITY = 10;

    private E[] array; // elements stored in heap
    private int size; // number of elements stored in heap
    ...
    */
     ...
     * 
     * @return
     * the minimum element in this heap
     * 
     * @throws UnderfowException
     ...
     * 
     * @return
     * <code>true</code> if this heap is empty, otherwise <code>false</code>
     */
