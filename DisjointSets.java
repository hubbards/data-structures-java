...
public class DisjointSets {
    private int[] array; // forest of up trees
     ...
     * if given number of elements is not positive
     */
    ...
    /**
     * Forms the union of two given sets.
     * 
     * @param root1
     * the index of the root element of the first set
     * 
     * @param root2
     * the index of the root element of the second set
     * 
     * @throws IndexOutOfBoundsException
     * if the given indices are out of bounds
     * 
     * @note
     * Union-by-rank means make the tree with smaller rank a subtee of the tree
     * with larger rank. Union-by-rank becomes union-by-height without path
     * compression.
     */
     ...
     * 
     * @return
     * the index of the root element of the set containing the element at the
     * given index.
     * 
     * @throws IndexOutOfBoundsException
     ...
     * 
     * @param root
     * the index of the root element of the set
     * 
     * @throws IndexOutOfBoundsException
     * if the given index is out of bounds
     */
